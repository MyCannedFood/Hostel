    ...
    <div class="bed-room-container">
        ...
        <div class="room-detail-card">
            <div class="room-detail-image-wrap">
                <img src="{{ asset('images/sharedroom/room_1.png') }}" alt="Serene Haven Room" class="room-detail-image"
                    onerror="this.src='https://images.unsplash.com/photo-1555854877-bab0e564b8d5?auto=format&fit=crop&q=80&w=800'">
                <span class="male-only-badge">MALE ONLY</span>
            </div>
            <div class="room-detail-info">
                <h3 class="room-detail-title">Serene Haven</h3>
