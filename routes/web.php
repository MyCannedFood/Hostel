...
Route::middleware(['is_admin'])->group(function () {
    ...
    Route::get('/Admin/Rooms-Management', fn () => view('admin.room-bed'))->name('admin.rooms');
    Route::get('/Admin/Manage-Bookings', fn () => view('admin.dashboard-layout', ['page' => 'Booking']))->name('admin.bookings');
    Route::get('/Admin/Price-Management', fn () => view('admin.dashboard-layout', ['page' => 'Article']))->name('admin.article');
    Route::get('/Admin/Finance', fn () => view('admin.dashboard-layout', ['page' => 'Budgetin & Report']))->name('admin.finance');
    Route::get('/Admin/Settings', fn () => view('admin.dashboard-layout', ['page' => 'Settings']))->name('admin.settings');

    Route::get('/admin/finance-accounting', fn () => view('admin.finance-accounting'))->name('admin.finance-accounting');
    ...
    Route::post('/admin/budgeting/approve-reject', [\App\Http\Controllers\AdminBudgetingController::class, 'approveReject'])->name('admin.budgeting.approve-reject');
